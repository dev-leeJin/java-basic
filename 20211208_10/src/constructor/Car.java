...
public class Car {
	...
	public Car(int g, int s, String o) { //# int 부분은 지운다음 밑에 게스와 스피드에 값을 직접 넣어도됌.
		gas = g;  //80                   //# ex) public Car (String o) , Car a = new Car("장성빈");
		speed = s; //0
		owner = o; 
	...
	// 자동차 동작 추가하기 (계기판 보기)
	public void getInfo() { //# 명령어를 헷갈릴걸 방지하기 위해 getInfo로 통일
