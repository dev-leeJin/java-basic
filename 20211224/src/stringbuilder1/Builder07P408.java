...
public class Builder07P408 {
	...
	public static void main(String[] args) {
		...
		// String으로 교체할때는 str.toString();을 붙여서 자료변환을 합니다.
		...
		StringBuilder str2 =new StringBuilder(hangul); //위에도 문자열(스트링)을 StringBuilder 타입으로 바꾸기 위해 
		System.out.println(str2);					   //new로 생성했음. 똑같이 진행하면 됌.
